// @see https://github.com/sadmann7/sortable/blob/main/src/components/ui/sortable.tsx
...
interface SortableItemProps extends SlotProps {
  ...
  /**
   * Disables the item from being sortable.
   * @default false
   * @type boolean | undefined
   */
  disabled?: boolean
...
const SortableItem = React.forwardRef<HTMLDivElement, SortableItemProps>(
  ({ value, asTrigger, asChild, className, disabled = false, ...props }, ref) => {
    const {
      attributes,
      listeners,
      setNodeRef,
